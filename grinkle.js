...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "668c496e7ceb7d41bf2496e9|7090cebc-87b3-2947-59c9-5e17e3bbebef",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-2": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "668c496e7ceb7d41bf2496e9|17686071-eae0-4598-697b-d3763073a6a6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-3": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "668c496e7ceb7d41bf2496e9|fb1a3b57-abb0-5ede-b100-df4c02b5f970",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-4": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "668c496e7ceb7d41bf2496e9|edf89201-83da-3ffc-b1f8-2a2a3473ec37",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-5": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "668c496e7ceb7d41bf2496e9|b4d1e756-c260-63b8-09f1-99f45ae951e7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-6": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "668c496e7ceb7d41bf2496e9|6b2faccd-fb59-9782-1f43-462570816224",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-7": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "668c496e7ceb7d41bf2496e9|6dfc65ef-ef71-8981-9aa7-23b5d58e2694",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-12": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "668c496e7ceb7d41bf2496e9|4775031e-a4d2-2210-7665-9185f6775bc0",
      },
      targets: [],
      config: {
        loop: false,
  ...
  actionLists: {
    ...
    "a-4": {
      ...
      createdOn: 1720471322643,
    },
    "a-5": {
      id: "a-5",
      title: "block_tokenomics",
      continuousParameterGroups: [
        {
          id: "a-5-p",
          type: "SCROLL_PROGRESS",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "668c496e7ceb7d41bf2496e9|06ccdba5-f91a-839f-9103-7bd12b6a4227",
                },
                xValue: -9,
                xUnit: "px",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "668c496e7ceb7d41bf2496e9|480e61de-a8a5-6161-a55e-cf9e9a0344ee",
                },
                value: 1,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["f9631e0b-6a5e-fc4c-24c9-401189ebed5c"],
                },
              },
            },
          ],
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "668c496e7ceb7d41bf2496e9|ab2e1333-ccd1-8d1d-b8cd-0624d8ff5e9f",
                },
                value: 0,
                unit: "",
              },
...
document.addEventListener("mousemove", (event) => {
  const eyes = document.getElementById("moving-eyes");
  const container = document.querySelector(".block_hero_chara");
  const containerRect = container.getBoundingClientRect();

  // Вираховуємо позицію курсора відносно контейнера
  const cursorX = event.clientX - containerRect.left;
  const cursorY = event.clientY - containerRect.top;

  // Центруємо очі у межах контейнера
  const centerX = containerRect.width / 2;
  const centerY = containerRect.height / 2;

  // Обмежуємо рух зображення
  const maxOffset = 6; // Максимальне зміщення очей
  const offsetX = Math.min(maxOffset, Math.max(-maxOffset, (cursorX - centerX) / 10));
  const offsetY = Math.min(maxOffset, Math.max(-maxOffset, (cursorY - centerY) / 10));

  // Змінюємо положення очей
  eyes.style.transform = `translate3d(${offsetX}px, ${offsetY}px, 0px)`;
});